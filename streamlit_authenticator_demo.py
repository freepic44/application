...
if st.session_state["authentication_status"]:
    try:
        username_of_forgotten_password = st.session_state["username"]  # Define the variable
        if authenticator.reset_password(username_of_forgotten_password):
            st.success('Password modified successfully')
            # Ensure new_random_password is defined before using it
            new_random_password = "your_new_password_here"  # Define or generate a new password
...
try:
    (username_of_forgotten_password,
     ...
     new_random_password) = authenticator.forgot_password()  # Ensure this returns a new password
